...
import { Server, BIMViewer, LocaleService } from "./libs-xeokit/xeokit-bim-viewer.es.js"
import {messages as localeMessages} from "./libs-xeokit/messages.js"
...
bimViewer.loadProject(projectId, () => {
    console.log(requestParams.modelId)
